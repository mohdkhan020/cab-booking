    ...
    <div className="container py-5">
        ...
        <div className="col-lg-4 mb-4">
          <div className="card shadow-sm">
            ...
            <div className="card-body">
              ...
              <p className="tour card-text">
                Planning an outstation trip? We provide comfortable rides for
      ...
      <div className="row mt-5">
        <div className="col-md-12 text-center">
          ...
          <p className="tour">
            Whether you're touring the city, heading to the airport, or going on
            a long-distance journey, we guarantee a safe and comfortable ride
