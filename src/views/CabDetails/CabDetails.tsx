          ...
          <div className="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
            <div className="cab-info" style={{ textAlign: "left" }}>
              ...
              <p className="cab-image-description">
                Looking for the best cab service in Bareilly? Kashif Cab offers
                reliable and affordable taxi services for all your travel needs.
                Whether you need a one-way cab, airport transfer, city tour, or
                intercity travel, our well-maintained fleet, including Innova,
                Dzire, Etios, Tata Zest, and SUVs, guarantees a comfortable
                ride. Book Bareilly cab service now for the cheapest fares and
                professional drivers. Choose Kashif Cab for a smooth, safe, and
                hassle-free journey across Bareilly and nearby cities.
                Experience top-rated car rental services with us today!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
            <div className="cab-info">
              ...
              <p className="cab-image-description">
                ...
                solutions. Experience top-notch service and seamless rides with
                Kashif Cab, your go-to taxi service in Bareilly.
              </p>
            </div>
          </div>
          <div className="d-flex col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 align-items-center justify-content-center">
        ...
        <div className="row g-0 text-center mb-5">
          <div className="cab-info-card col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
            <div className="">
              ...
              <p className="cab-description">
                India's Leading Intercity Car Rentals - Book Outstation & Local
                AC Cabs with Competitive Rates, Clean Vehicles, Professional
                Drivers & Transparent Billing.
              </p>
            </div>
          </div>
          <div className="cab-info-card col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
